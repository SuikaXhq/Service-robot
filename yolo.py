...
class YOLO(object):
    def __init__(self):
        self.model_path = 'deep_sort_yolov3-master/model_data/yolo.h5'
        self.anchors_path = 'deep_sort_yolov3-master/model_data/yolo_anchors.txt'
        self.classes_path = 'deep_sort_yolov3-master/model_data/coco_classes.txt'
        #具体参数可实验后进行调整
